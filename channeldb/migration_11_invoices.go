...
func migrateInvoices(tx *bbolt.Tx) error {
	...
	monaNets := []*monacoinCfg.Params{
		&monacoinCfg.MainNetParams, &monacoinCfg.SimNetParams,
		&monacoinCfg.RegressionNetParams, &monacoinCfg.TestNet4Params,
	}
	for _, net := range monaNets {

...
```
$ go-fuzz-build github.com/monasuite/lnd/lnwire/<folder name here>
```
* Now, run `go-fuzz`!!!
```
...
this earlier, `go-fuzz` found two bugs ([#310](https://github.com/monasuite/lnd/pull/310) and [#312](https://github.com/monasuite/lnd/pull/312)) within minutes!

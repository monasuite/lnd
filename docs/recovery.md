...
[`cipher seed`](https://github.com/monasuite/lnd/tree/master/aezeed).
...
[`dropwtxmgr`](https://github.com/monaarchives/btcwallet/tree/master/cmd/dropwtxmgr).
It can be installed with the following command:
```
⛰  go get -v -u github.com/monaarchives/btcwallet/cmd/dropwtxmgr
```
...
Once the process has been initiated, `lnd` will proceed to:
  ...
  2. Once the channel shell is recovered, the
     [chanbackup](https://github.com/monasuite/lnd/tree/master/chanbackup)

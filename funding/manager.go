...
const (
	...
	// MinMonaRemoteDelay is the minimum Monacoin CSV delay we will require the
	// remote to use for its commitment transaction.
	MinMonaRemoteDelay uint16 = 960

	// MaxMonaRemoteDelay is the maximum Monacoin CSV delay we will require the
	// remote to use for its commitment transaction.
...
func (f *Manager) handleInitFundingMsg(msg *InitFundingMsg) {
	...
	case chainreg.MonacoinChain:
		ourDustLimit = chainreg.DefaultMonacoinDustLimit
	}
